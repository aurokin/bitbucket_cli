...
__bb_get_completion_results() {
    ...
    # Calling ${words[0]} instead of directly bb allows handling aliases
    args=("${words[@]:1}")
...
__bb_handle_standard_completion_case() {
    ...
    if ((${#COMPREPLY[*]} == 1)); then
        ...
        __bb_debug "Removed description from single completion, which is now: ${COMPREPLY[0]}"
    else
