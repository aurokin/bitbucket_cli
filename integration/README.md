...
BB_RUN_INTEGRATION=1 go test -tags=integration ./integration -run TestBitbucketCloudWorkspaceRead -v
BB_RUN_INTEGRATION=1 go test -tags=integration ./integration -run TestBitbucketCloudProjectRead -v
BB_RUN_INTEGRATION=1 go test -tags=integration ./integration -run TestBitbucketCloudProjectMutation -v
BB_RUN_INTEGRATION=1 go test -tags=integration ./integration -run TestBitbucketCloudBranchFlow -v
BB_RUN_INTEGRATION=1 go test -tags=integration ./integration -run TestBitbucketCloudTagFlow -v
...
- The `project delete` test uses a dedicated sacrificial empty project and deletes only that project.
