...
func GenerateJSONFieldsDoc() (string, error) {
	entries := []jsonFieldDocEntry{
		...
		{Command: "bb deployment list", Type: deploymentListPayload{}},
		{Command: "bb deployment view", Type: deploymentPayload{}},
		{Command: "bb deployment environment list", Type: deploymentEnvironmentListPayload{}},
		{Command: "bb deployment environment view", Type: deploymentEnvironmentPayload{}},
		{Command: "bb deployment environment variable list", Type: deploymentVariableListPayload{}},
		{Command: "bb deployment environment variable view", Type: deploymentVariablePayload{}},
